...
```{r}
library(rjson)
filtered_clusters <- fromJSON(file = "C:/Users/bre227/Dropbox/eQTL/Results/cluster_data/gene_clusters_filtered.json")
...
```{r}
gene_clusters_raw <- fromJSON(file = "C:/Users/bre227/Dropbox/eQTL/Results/cluster_data/gene_clusters_raw.json")
```
...
gns_in_clstrs <- read.table("C:/Users/bre227/Dropbox/eQTL/Results/cluster_data/gene_clusters_PC1.csv", sep = ",", header = T)
...
rosmap_data <- read.delim("C:/Users/bre227/Dropbox/eQTL/Data/ROSMAP_Data/ROSMAP_arrayExpression_normalized.tsv")

# read in metadata
rosmap_meta <- read.csv("C:/Users/bre227/Dropbox/eQTL/Data/ROSMAP_Data/ROSMAP_clinical.csv")
...
rosmap_data2 <- dplyr::left_join(rosmap_data1,
                                 dplyr::select(rosmap_meta, projid, study, age_at_visit_max, msex, braaksc),
                                 by = c("sample_id" = "projid"))
rosmap_data2 <- dplyr::select(rosmap_data2, sample_id, study, age_at_visit_max, msex, braaksc, everything())
```
...
# colour by sex 
autoplot(pca_rosmap, data = dplyr::filter(rosmap_data2, !is.na(msex)), colour = "msex", label = T) +
  viridis::scale_colour_viridis(option = "viridis", discrete = T)

# colour by braaksc
autoplot(pca_rosmap, data = rosmap_data2, colour = "braaksc", label = T) +
  viridis::scale_colour_viridis(option = "viridis", discrete = T)
