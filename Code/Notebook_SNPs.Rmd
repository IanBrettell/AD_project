...
*Each of the values in ll is a list of 218 vectors, whcih is the first eigenvalue.

*We have 249 root genes within each cluster. The root gene is the gene that was differentially expressed in the first limma.

* The correlated gene is only signficiant because the correlation between local group 1 and local group 2 was signficantly different. Then we take an SVD of those genes that are signficintly different. 

*Then we do that for all 249 genes, and we compare our predictions using the eigenvalues to our intiail limma results, and we can identify the genes for which using the eigenvalue has improved the prediction of AB. 
